        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          ...
          {!showCalendar && (
            <div className="flex gap-2">
              <button
                className={`py-2 px-3 rounded-lg text-xs font-bold border transition-all duration-150 ${filter==='todas' ? 'bg-red-600 text-white border-red-600' : 'bg-white border-gray-200 text-gray-600 hover:border-red-300'}`}
                onClick={() => setFilter('todas')}
              >
                Todas
              </button>
              <button
                className={`py-2 px-3 rounded-lg text-xs font-bold border transition-all duration-150 ${filter==='hoy' ? 'bg-red-600 text-white border-red-600' : 'bg-white border-gray-200 text-gray-600 hover:border-red-300'}`}
                onClick={() => setFilter('hoy')}
              >
                Hoy
              </button>
              <button
                className={`py-2 px-3 rounded-lg text-xs font-bold border transition-all duration-150 ${filter==='proximas' ? 'bg-red-600 text-white border-red-600' : 'bg-white border-gray-200 text-gray-600 hover:border-red-300'}`}
                onClick={() => setFilter('proximas')}
              >
                Próximas
              </button>
              <button
                className={`py-2 px-3 rounded-lg text-xs font-bold border transition-all duration-150 ${filter==='pasadas' ? 'bg-red-600 text-white border-red-600' : 'bg-white border-gray-200 text-gray-600 hover:border-red-300'}`}
          ...
          <button
            className="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-lg transition-all duration-200 ml-2 whitespace-nowrap text-base"
