          ...
          <div className="rounded-md shadow-sm -space-y-px">
            <div className="relative">
              ...
              <input
                ...
                className="appearance-none rounded-t-md relative block w-full px-3 py-3 pl-10 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-red-500 focus:border-red-500 focus:z-10 sm:text-sm transition duration-150 ease-in-out autofill:bg-transparent bg-transparent"
            ...
            <div className="relative">
              ...
              <input
                ...
                className="appearance-none rounded-b-md relative block w-full px-3 py-3 pl-10 pr-10 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-red-500 focus:border-red-500 focus:z-10 sm:text-sm transition duration-150 ease-in-out autofill:bg-transparent bg-transparent"
