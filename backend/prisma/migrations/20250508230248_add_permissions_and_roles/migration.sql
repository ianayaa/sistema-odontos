...
BEGIN
    -- Para usuarios ADMIN
    FOR user_record IN SELECT id FROM "User" WHERE role = 'ADMIN' LOOP
    ...
    -- Para usuarios DENTIST
    FOR user_record IN SELECT id FROM "User" WHERE role = 'DENTIST' LOOP
        FOR permission_id IN 
    ...
    -- Para usuarios ASSISTANT
    FOR user_record IN SELECT id FROM "User" WHERE role = 'ASSISTANT' LOOP
        FOR permission_id IN 
    ...
    -- Para usuarios PATIENT
    FOR user_record IN SELECT id FROM "User" WHERE role = 'PATIENT' LOOP
        FOR permission_id IN 
